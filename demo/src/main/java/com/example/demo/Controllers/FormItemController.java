...
public class FormItemController implements Initializable {
    ...
    void save(ActionEvent event) {
        ...
        String query = String.format("INSERT INTO `item`(`item_id`, `item_price`, `category_id`, `item_name`) VALUES ('%d','%d','%d','%s')", id, price, categoryId, name);
